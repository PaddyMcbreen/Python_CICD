...
class userInputTests(unittest.TestCase):
    ...
    def test_guessIsNum(self, mock_input):
        # Arrange & Act
        "Checks that the user input will work with a random integer"
        guess = play_game()        
        # Assert
    ...
    def test_guessIsNum2(self, mock_input):
        # Arrange & Act
        "Checks that the user input with convert a numbered string to an integer"
        guess = play_game()        
        # Assert
        self.assertEqual(type(guess), int)
        "Test Complete - Passed"
...
class expectedFailureTests(unittest.TestCase):
    ...
    def test_UserInputStr(self, mock_input):
        # Arrange & Act
        "Checks that the user input will not allow strings that cannot convert to a number"
        guess = play_game()        
        # Assert
